  ...
  <ContentPanel>
    ...
    >
      <p>
        ...
        ease with which they bounce between weighty cinematic masterpieces, arty
        slow-burners, and frivolous comedies. They play within and against genre
        so effortlessly, and there is obvious glee behind every line of dialogue
      ...
      <p>
        ...
        Coens pepper every film with unforgettable performances by actors we've
        (mostly) never heard of. And often, I've come to notice, these character
        actors show up behind desks.
      </p>
      <p>
        They usually appear as clerks or administrators, indifferent faces of a
        higher bureaucratic power, thwarting the goals of an increasingly
        ...
        comprehend. And sometimes they're pure comic relief. But they are always
        so pitch-perfect, so distinct and authentic, it's hard to conceive of
        these actors in any other role.
      </p>
      <p>
        Like Tarantino's{' '}
